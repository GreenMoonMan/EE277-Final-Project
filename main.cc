...
int main()
{
	...
	// -------------------- Main Menu Loop --------------------
	    while (1)
	    {
	        ...
	        xil_printf("3 - Filters Mode (TODO IMPLEMENT)\r\n");
	        xil_printf("q - Quit\n\r> ");
	    	xil_printf("\n\r");
	    	xil_printf("\n\r");
                       ...
                       VideoOutput& vid)
{
    ...
    while (1)
    {
        ...
        case 'a':
        {
        	...
        	// overlay "1234"
        	overlay_number_on_slot(fifoA[indexA], width, height, stride, "1234", bottom_margin, whiteBGR);
