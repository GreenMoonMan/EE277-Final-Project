...
HD_PWD='Z:/EE_277/final_proj/lab_camera/lab_camera/camera/camera/2023.1/Zybo-Z7-10-Pcam-5C-hw.xpr/hw/hw.runs/edge_detect_hw_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log edge_detect_hw_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source edge_detect_hw_0.tcl
