...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot edge_detect_hw_0 xil_defaultlib.edge_detect_hw_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim edge_detect_hw_0 -key {Behavioral:sim_1:Functional:edge_detect_hw_0} -tclbatch cmd.tcl -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb edge_detect_hw_0.wdb xsim.dir libdpi.so)
