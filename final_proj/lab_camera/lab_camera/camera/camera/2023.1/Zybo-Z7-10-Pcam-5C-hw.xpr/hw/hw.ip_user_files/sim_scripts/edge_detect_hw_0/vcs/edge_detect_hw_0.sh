...
#
# Script generated by Vivado on Mon Nov 17 22:53:17 -0800 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : edge_detect_hw_0.sh
...
#
# Usage        : edge_detect_hw_0.sh
#                edge_detect_hw_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                edge_detect_hw_0.sh [-reset_run]
#                edge_detect_hw_0.sh [-reset_log]
#                edge_detect_hw_0.sh [-help]
#
...
#                script (type 'edge_detect_hw_0.sh -help' for more information).
#
...
# script info
echo -e "edge_detect_hw_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./edge_detect_hw_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"Z:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"Z:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"Z:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.edge_detect_hw_0 xil_defaultlib.glbl -o edge_detect_hw_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./edge_detect_hw_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key edge_detect_hw_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc edge_detect_hw_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./edge_detect_hw_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: edge_detect_hw_0.sh [-help]\n\
Usage: edge_detect_hw_0.sh [-step]\n\
Usage: edge_detect_hw_0.sh [-lib_map_path]\n\
Usage: edge_detect_hw_0.sh [-reset_run]\n\
Usage: edge_detect_hw_0.sh [-reset_log]\n\
Usage: edge_detect_hw_0.sh [-keep_index]\n\
Usage: edge_detect_hw_0.sh [-noclean_files]\n\n\
