...
namespace eval ::optrace {
  variable script "/home/moon/school_stuff/sem14/EE277/labs/vivado_277/keypad_test1/keypad_test1.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /home/moon/school_stuff/sem14/EE277/labs/vivado_277/keypad_test1/keypad_test1.runs/synth_1/design_1_wrapper.dcp
...
OPTRACE "Write Bitstream: pre hook" START { }
  set src_rc [catch { 
    puts "source /home/moon/school_stuff/sem14/EE277/labs/vivado_277/lab3_277_jm/pins.tcl"
  ...
  if {$src_rc} { 
    ...
    if { $tool_flow eq {SDx} } { 
      ...
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script /home/moon/school_stuff/sem14/EE277/labs/vivado_277/lab3_277_jm/pins.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script /home/moon/school_stuff/sem14/EE277/labs/vivado_277/lab3_277_jm/pins.tcl failed"
    }
    return -code error
  }
